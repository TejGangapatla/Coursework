...
public class Student {
    ...
    public String insertStudent(@FormDataParam("id") Integer id,
        ...
        try {
            ...
            System.out.println("Database error: " + exception.getMessage());
            return "{\"error\": \"Unable to create new Student, please see server console for more info.\"}";
        }
    }
    ...
    public String listStudent () {
        ...
        try {
            ...
            System.out.println("Database error: " + exception.getMessage());
            return "{\"error\": \"Unable to list Students, please see server console for more info.\"}";
        }
    }
    ...
    public String deleteStudent(@FormDataParam("id") Integer id) {
        ...
        try {
            ...
            System.out.println("Database error: " + exception.getMessage());
            return "{\"error\": \"Unable to delete Student, please see server console for more info.\"}";
        }
    }
