...
/*
    public static void insertThing(int UserID, String Name, int Age, String Email) {
        ...
        try {
            ...
            PreparedStatement ps = Main.db.prepareStatement(
                    "INSERT INTO Student (UserID, Name, Age, Email) VALUES (?, ?, ?, ?)");
    ...
    public static void updateThing(int UserID, String Name, int Age, String Email) {
    ...
    public static void deleteThing(int UserID) {
